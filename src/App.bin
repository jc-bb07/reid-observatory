...
function AboutTab({ C }) {
  ...
  // **text** → bold C.text
  // Specific phrases get special treatment via a find-and-replace pass
  const renderPara = (p, i, extraStyle = {}) => {
    // Split on bold **x**, italic *x*, and known highlight phrases
    const HIGHLIGHTS = [
    ...
    // Handle *italic* within remaining strings
