  ...
  return (
    <div style={{ maxWidth: 780, margin: "0 auto" }}>
      ...
      <div style={{
        ...
        microdata as a proxy. Results are illustrative — this is a prototype pending
        calibration data from Statistics IoM, Statistics Jersey, and Statistics Guernsey.
      </div>
...
// ── Centred wrapper for login / loading ───────────────────────────────────────
...
function AppContent() {
  ...
  // Tab button style — note: backgroundImage:none prevents the select arrow
  // SVG from the global stylesheet bleeding into <button> elements
  const tabBtn = (t) => {
      ...
      <button
        ...
        style={{
          ...
          color: isRestricted
            ...
            : (isActive ? C.blue : C.muted),
          borderBottom: isActive
            ? `2px solid ${isRestricted ? C.purple : C.blue}`
  ...
  return (
    <div style={{
      ...
      {/* Content — iframes get full bleed, other tabs centred with max-width */}
      <div style={
        tab === "reid" || tab === "demog" || tab === "kanon" || tab === "areas"
          ? {}
