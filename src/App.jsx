...
const TAB_GROUPS = [
  ...
  { id: "econ-group", label: "Economy & Society",  color: "#34d399", homeTab: "econHome", tabs: ["econHome", "demog", "iomfiscal", "econmix", "inflation", "unemployment", "suicide", "workforce", "nobles","nobles-v15"] },
];
    ...
    <div style={{ maxWidth: 780, margin: "0 auto" }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 13, color: C.muted2, lineHeight: 1.8 }}>
          ...
          This section explores those dynamics — population aging, fiscal flows, and the
      ...
      <div onClick={() => onNavigate("iomfiscal")} style={{ cursor: "pointer" }}>
        {card(
          "IoM Fiscal Flows",
          ...
          (health, education, social security, infrastructure). Data extracted from
          Treasury published accounts. Check the numbers.`,
          C.green
        )}
      </div>
      ...
      {/* Systems dynamics note */}
      <div style={{
        background: C.surface2, border: `1px solid ${C.border2}`,
        borderRadius: 8, padding: "14px 16px", marginBottom: 24,
        fontSize: 11, color: C.muted2, lineHeight: 1.7,
      }}>
        <span style={{ color: C.muted, fontWeight: 600 }}>Why systems dynamics? · </span>
        Fiscal sustainability in small islands isn't a static spreadsheet problem — it's a
        set of feedback loops. An aging population increases health and pension expenditure
        while shrinking the working-age tax base, which constrains the public investment
        that might attract working-age incomers, which further strains the ratio. Modelling
        these loops explicitly, rather than extrapolating trend lines, is the point.
        The model is in active development — more loops, more islands, more data as we go.
      </div>
...
function AppContent() {
  ...
  const tabContent = {
    ...
    reid: (
      <AutoIframe
        src="/reidentification.html"
        title="Re-identification Observatory"
      />
    ),
