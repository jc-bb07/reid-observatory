      ...
      <div style={S.card}>
        ...
        {activeQIs.includes("manx_language") && island === "iom" && (
          <div style={{
            ...
            marginBottom:12, border:`1px solid ${nonWhiteEthnicity ? "#1e293b" : "#334155"}`,
            display:"flex", alignItems:"center", justifyContent:"space-between",
            opacity: nonWhiteEthnicity ? 0.4 : 1,
          }}>
            <div>
              <div style={{ ...S.label, marginBottom:2, display:"flex", gap:6, alignItems:"center" }}>
                Manx Speaker <DataBadge type="published_exact"/>
                {nonWhiteEthnicity && (
                  <span style={{ color:"#475569", fontSize:9 }}>— mutually exclusive with ethnicity filter</span>
                )}
              </div>
              {manxContext && area && !nonWhiteEthnicity && (
            ...
            <button
              ...
              style={{
                ...
                cursor: nonWhiteEthnicity ? "not-allowed" : "pointer",
              }}>
        ...
        {activeQIs.includes("ethnicity_nonwhite") && island === "iom" && (
          <div style={{
            background:"#0f172a", borderRadius:8, padding:"12px 14px",
            marginBottom:12, border:`1px solid ${manxSpeaker ? "#1e293b" : "#334155"}`,
            display:"flex", alignItems:"center", justifyContent:"space-between",
            opacity: manxSpeaker ? 0.4 : 1,
          }}>
            <div style={{ flex:1, minWidth:0 }}>
              <div style={{ ...S.label, marginBottom:2, display:"flex", gap:6, alignItems:"center" }}>
                Non-White Ethnicity <DataBadge type="modelled_estimate"/>
                {manxSpeaker && (
                  <span style={{ color:"#475569", fontSize:9 }}>— mutually exclusive with Manx filter</span>
                )}
              </div>
              {ethContext && area && !manxSpeaker && (
                <div style={{ color:"#64748b", fontSize:11 }}>
            ...
            <button
              ...
              style={{
                ...
                fontSize:12, fontWeight:600,
                cursor: manxSpeaker ? "not-allowed" : "pointer",
                flexShrink:0,
              }}>
